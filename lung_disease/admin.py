...
from .models import PatientProfile, PatientReport, Blog, ContactInfo, DoctorProfile, ContactMessage
...
class PatientReportAdmin(admin.ModelAdmin):
    list_display = ('patient', 'image', 'uploaded_at', 'prediction', 'needs_doctor_assistance')
    search_fields = ('patient__user__username', 'prediction')
    list_filter = ('uploaded_at', 'prediction', 'needs_doctor_assistance')
